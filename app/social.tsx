...
const styles = StyleSheet.create({
  ...
  userHandle: { color: Colors.textSecondary, fontSize: FontSize.sm, fontWeight: '500' },
  ...
  pendingBtn: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 99, borderWidth: 1, borderColor: Colors.border },
