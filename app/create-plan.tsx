...
const styles = StyleSheet.create({
  ...
  coverPlaceholder: {
    height: 100, backgroundColor: Colors.card, alignItems: 'center', justifyContent: 'center',
  },
  ...
  dateModalContent: { backgroundColor: Colors.card, borderTopLeftRadius: Radius.xl, borderTopRightRadius: Radius.xl, paddingBottom: 30 },
  dateModalHeader: {
  ...
  pollSection: { gap: Spacing.sm, backgroundColor: Colors.card, borderRadius: Radius.md, padding: Spacing.md, borderWidth: 1, borderColor: Colors.border },
